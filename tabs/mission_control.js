...
*/
	...
	function initMap() {
		...
		app.PlannerSettingsControl = function (opt_options) {
			...
			button.innerHTML = ' ';
			button.style = 'background: url(\'../images/CF_settings_black.svg\') no-repeat 1px -1px;background-color: rgba(0,60,136,.5);';
		...
		app.PlannerSafehomeControl = function (opt_options) {
			...
			button.innerHTML = ' ';
			button.style = 'background: url(\'../images/icons/cf_icon_safehome_black.svg\') no-repeat 1px -1px;background-color: rgba(0,60,136,.5);';
		...
		app.PlannerElevationControl = function (opt_options) {
			...
			button.innerHTML = ' ';
			button.style = 'background: url(\'../images/icons/cf_icon_elevation_black.svg\') no-repeat 1px -1px;background-color: rgba(0,60,136,.5);';
		...
		app.PlannerMultiMissionControl = function (opt_options) {
			...
			button.innerHTML = ' ';
			button.style = 'background: url(\'../images/icons/cf_icon_multimission_black.svg\') no-repeat 1px -1px;background-color: rgba(0,60,136,.5);';
		...
		function getMiXAirMissionFromApi() {
			...
			request.done(function (msg) {
				GUI.log("Got mission waypoints from API");
				GUI.log(msg);
		...
		$('#saveSettings').on('click', function () {
			...
			settings = {
				speed: Number($('#MPdefaultPointSpeed').val()),
				alt: Number($('#MPdefaultPointAlt').val()),
				safeRadiusSH: Number($('#MPdefaultSafeRangeSH').val()),
				maxDistSH: vMaxDistSH
			};
			saveSettings();
	...
	function saveMissionFile(filename) {
		...
		var builder = new window.xml2js.Builder({
			'rootName': 'mission',
